    ...
    <div className='experience'>
      ...
      <div className='experience__container'>
        ...
        <div className='experience__card'>
            ...
            <div>
                <p>
                    Dirigo la parte del fornt-end de los desarollos internos de la empresa
                </p>
                <div className='technologies___card_container'>
                    <img src={github} width={35} alt="icono de react"/>
                    <img src={git} width={35} alt="icono de react"/>
        ...
        <div className='experience__card'>
            ...
            <div className='btns__card_container'>
                <a href="https://cms-01.vercel.app" className="btn__card" target="_blank" rel="noopener noreferrer">Ver CRM</a>
