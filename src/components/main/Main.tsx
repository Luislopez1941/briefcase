            ...
            <section className="education">
                ...
                <div className="container__education">
                    <div>
                        ...
                        <button
                            className="button-title-account"
                            onClick={() => window.open(cedulaPDF, '_blank')}>
                            Ver título
                        </button>
